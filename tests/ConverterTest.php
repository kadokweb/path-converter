...
namespace KadokWeb\PathConverter\Tests;
...
class ConverterTest extends TestCase
{
    ...
    public function dataProvider()
    {
        ...
        // https://github.com/kadokweb/path-converter/issues/1
        $tests[] = array(
            'image.jpg',
        ...
        // https://github.com/kadokweb/path-converter/issues/4
        $tests[] = array(
        ...
        // https://github.com/kadokweb/path-converter/issues/6
        $tests[] = array(
